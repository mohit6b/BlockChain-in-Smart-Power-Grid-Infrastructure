    ...
    return (
      <div>
        <div className="w3-cell-row w3-container w3-padding-16">
          ...
          <div className="w3-cell w3-right buttonCell pointer" title="Supply Tracking" onClick={() => this.props.history.push('/supplyDetails/all')}>
            <i className="fa fa-ship" aria-hidden="true" style={{fontSize: '32px'}}></i>
          </div>
          <div className="w3-cell w3-right buttonCell pointer" title="Transfer Transactions" onClick={() => this.props.history.push('/')}>
